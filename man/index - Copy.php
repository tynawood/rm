...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post" name="zipform">
            <label>Enter your ZIP Code: <input type="text" name="zipcode" size="6" maxlength="5" value="" /></label>
            <br />
        ...
        <?php
			if(isset($_POST['submit'])) {
				...
				elseif(!preg_match('/^[0-9]{1,3}$/', $_POST['distance'])) {
					...
					if(!$rs = mysql_query("SELECT * FROM zipcodes WHERE zip_code = '$_POST[zipcode]'")) {
